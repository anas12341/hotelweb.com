...
if(empty($err))
{
    $sql = "SELECT id, username, password FROM users_reg WHERE username = ?";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <!-- Add these links/buttons wherever you want the theme switcher to appear -->
...
<!-- Header End -->
  ...
  <body>
    <div class="container mt-4 mb-5 formedit">
